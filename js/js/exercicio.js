...
function entrarBalada(){
    ...
    let nasceuCampinas = prompt("Nasceu em campinas patrão? (y/n)").toLowerCase()

    if (idade >= 18 && (mesNascido == 2 || mesNascido == 4 || mesNascido == 6 || mesNascido == 8 || mesNascido == 9) && nasceuCampinas == "y"){
